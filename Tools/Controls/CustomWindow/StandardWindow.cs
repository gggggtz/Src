...
namespace Controls.CustomWindow
{
    public class StandardWindow : Window
    {
        ...
        // This enables to use the Controls.CustomWindow in Visual Studio design mode. If DependencyProperties are used, the design mode does not work then.
