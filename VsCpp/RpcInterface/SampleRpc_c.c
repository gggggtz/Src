...
handle_t hSampleRpcBinding;


static const RPC_CLIENT_INTERFACE SampleRpc___RpcClientInterface =
    {
...
RPC_IF_HANDLE SampleRpc_v1_0_c_ifspec = (RPC_IF_HANDLE)& SampleRpc___RpcClientInterface;

extern const MIDL_STUB_DESC SampleRpc_StubDesc;

static RPC_BINDING_HANDLE SampleRpc__MIDL_AutoBindHandle;
    ...
    /* [string][in] */ const char *szOutput)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&SampleRpc_StubDesc,
                  (PFORMAT_STRING) &SampleRpc__MIDL_ProcFormatString.Format[0],
...
static const MIDL_STUB_DESC SampleRpc_StubDesc = 
    {
    (void *)& SampleRpc___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hSampleRpcBinding,
    0,
